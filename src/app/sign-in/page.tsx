                ...
                <div className="glass-card rounded-2xl p-8">
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-[#12141c] px-4 text-muted-foreground">Or continue with</span>
                        </div>
                    </div>
                    ...
                    <Button
                        variant="outline"
                        type="button"
                        className="w-full bg-secondary/50 border-white/10 hover:bg-secondary/80 transition-colors"
